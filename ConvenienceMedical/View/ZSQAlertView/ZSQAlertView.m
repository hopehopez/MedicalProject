...
#define TINT_COLOR [UIColor colorWithRed:0 green:169/255.0 blue:155/255.0 alpha:1]
#define CENTER_H  (self.frame.size.width-100)*0.6)

@implementation ZSQAlertView{
    ...
    id<ZSQAlertViewDelegate>  _delegate;
